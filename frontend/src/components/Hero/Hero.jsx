...
const Hero = () => {
    ...
    <div>
        <div className='herocontainer flex'>
         <div className='left h-96 bg-white w-1/2 justify-center items-center'>
     <h1 id='headingone' 
  className='font-bold' 
...
>
  ...
  <span className='text-yellow-300 inline'>Foodie</span> Zone
    ...
    <div className='right rounded-2xl bg-gradient-to-b from-yellow-400 to-yellow-300 via-yellow-300' style={{marginLeft:'3%',width:'40vw',height:'76vh',marginTop:'2%'}}>
        <h1 className='font-bold text-3xl bg-transparent text-black' style={{marginLeft:'30%',marginTop:'5%'}}>ADMIN PANEL</h1>
<form onSubmit={handleSubmit}>
      ...
      <button type="submit" className='bg-red-600 text-white font-bold w-30 h-8 cursor-pointer' style={{borderRadius:'26px',marginTop:'1%'}}>ADD DISH</button>
